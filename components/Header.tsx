    ...
    >
      ...
      {mobileOpen && (
        <div className="fixed inset-0 top-16 z-40 md:hidden">
          ...
          />
          <nav
            className="relative mx-4 mt-2 flex flex-col gap-1 rounded-xl border border-border bg-background p-4 shadow-lg animate-slide-up"
          ...
          >
            ...
            <Link
              href="/contact"
              onClick={() => setMobileOpen(false)}
              className="rounded-lg px-4 py-3 text-base font-medium text-muted-foreground transition-colors hover:bg-secondary"
            >
              Contact
            </Link>
            <Button
